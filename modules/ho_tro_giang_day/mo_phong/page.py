...
"""
    ...
    with tab_phet:
        ...
        st.markdown(
            "#### ⚛️ Tương tác trực tiếp PhET Simulations"
        )
        
        st.info("💡 Các mô phỏng dưới đây chạy hoàn toàn bằng HTML5, cho phép thầy cô và học sinh thao tác ngay trên hệ thống.")

        # Danh sách các link embed HTML5 (tiếng Việt) của PhET
        phet_sims = {
            "Trạng thái vật chất (Lý/Hóa)": "https://phet.colorado.edu/sims/html/states-of-matter-basics/latest/states-of-matter-basics_vi.html",
            "Cân bằng phương trình Hóa học": "https://phet.colorado.edu/sims/html/balancing-chemical-equations/latest/balancing-chemical-equations_vi.html",
            "Định luật Ohm (Vật lý)": "https://phet.colorado.edu/sims/html/ohms-law/latest/ohms-law_vi.html",
            "Lực và Chuyển động (Cơ bản)": "https://phet.colorado.edu/sims/html/forces-and-motion-basics/latest/forces-and-motion-basics_vi.html",
            "Khúc xạ ánh sáng (Vật lý)": "https://phet.colorado.edu/sims/html/bending-light/latest/bending-light_vi.html",
            "Xây dựng Nguyên tử (Hóa học)": "https://phet.colorado.edu/sims/html/build-an-atom/latest/build-an-atom_vi.html",
            "Bảo toàn Năng lượng (Trượt ván)": "https://phet.colorado.edu/sims/html/energy-skate-park-basics/latest/energy-skate-park-basics_vi.html",
            "Mật độ & Độ nổi (KHTN 8)": "https://phet.colorado.edu/sims/html/density/latest/density_vi.html"
        }

        # Tạo menu dropdown để chọn mô phỏng
        selected_sim_name = st.selectbox(
            "Chọn chủ đề mô phỏng:",
            list(phet_sims.keys())
        )

        # Nhúng iFrame chạy trực tiếp mô phỏng đã chọn
        if selected_sim_name:
            components.iframe(
                phet_sims[selected_sim_name], 
                height=600, 
                scrolling=False
            )

        st.markdown("---")
        st.markdown("#### Khám phá thêm kho học liệu chuẩn quốc tế")
        ...
        with col_phet:
            ...
            st.markdown(
                "Truy cập toàn bộ hàng trăm mô phỏng Khoa học "
                "Tự nhiên và Toán học của Đại học Colorado Boulder."
            )

            st.link_button(
                "🚀 MỞ TRANG CHỦ PHET (TAB MỚI)",
        ...
        with col_moza:
            ...
            st.markdown(
                "Thư viện cảnh 3D tương tác sắc nét "
                "và học liệu giáo dục (Sinh học, Hóa học...)."
            )

            st.link_button(
                "🌐 MỞ MOZAWEB 3D (TAB MỚI)",
