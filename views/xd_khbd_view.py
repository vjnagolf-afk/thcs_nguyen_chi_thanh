...
"""
============================================================
VIEW: GIAO DIỆN XÂY DỰNG KẾ HOẠCH BÀI DẠY (KIẾN TRÚC MỚI)
...
from views.xd_khbd_data import (
    init_session_state, get_nls_domains, get_nls_components, 
    get_nls_levels, get_nls_content,
    read_multiple_files, read_uploaded_file, read_template_local,
    add_nls, format_nls, add_activity, build_prompt, generate_ai, validate_khbd_result
)
...
def render_xd_khbd(ai_engine=None):
    ...
    if st.button("⚡ KÍCH HOẠT XỬ LÝ AI", type="primary", use_container_width=True):
        ...
        with st.spinner("🧠 Hệ thống đang phân tích đa tầng, kiểm định nguồn và biên soạn KHBD chuẩn..."):
            try:
