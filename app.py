...
try:
    ...
    if phan_he == "Hỗ trợ Giáo viên":
        ...
        tabs = st.tabs(["Hỏi đáp", "Trò chơi", "Chấm bài", "Tóm tắt tài liệu", "Mô phỏng LT TN ảo", "Phân tích KQ học tập", "Tạo đề nhanh", "Tạo Video","Truy vấn học liệu", "Cá nhân hóa", "Phân tích bài học","Tương tác trên lớp"])
